...
class GeneralSupervisorRepoStatisticsImpelment
    implements GeneralSupervisorRepo {
  @override
  ...
  @override
  Future<QuerySnapshot<Map<String, dynamic>>> getFemalestatistics(
      UserModel userModel) {
    Future<QuerySnapshot<Map<String, dynamic>>> value = FirebaseFirestore
        .instance
        .collection(churchNamesBasedOnCode[userModel.church])
        .doc(userModel.church)
        .collection('users')
        .where('gender', isEqualTo: 'انثي')
        .get();
    return value;
  }

  @override
  Future<QuerySnapshot<Map<String, dynamic>>> getMaleNumberStatistics(
      UserModel userModel) {
    Future<QuerySnapshot<Map<String, dynamic>>> value = FirebaseFirestore
        .instance
        .collection(churchNamesBasedOnCode[userModel.church])
        .doc(userModel.church)
        .collection('users')
        .where('gender', isEqualTo: 'ذكر')
        .get();
    return value;
  }

  @override
  Future<QuerySnapshot<Map<String, dynamic>>> getOurFatherStatistics(
      UserModel userModel) {
    Future<QuerySnapshot<Map<String, dynamic>>> value = FirebaseFirestore
        .instance
        .collection(churchNamesBasedOnCode[userModel.church])
        .doc(userModel.church)
        .collection('users')
        .where('currentService', isEqualTo: 'كاهن')
        .get();
    return value;
  }
}
