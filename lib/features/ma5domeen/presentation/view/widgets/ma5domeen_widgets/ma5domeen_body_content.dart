...
class Ma5domeenBodyContent extends StatelessWidget{
  const Ma5domeenBodyContent({super.key, required this.ma5doomName, required this.editDate, required this.stageName, required this.servedId, required this.ma5domeenModel});
...
final Ma5domeenModel ma5domeenModel;
  ...
  Widget build(BuildContext context) {
   return 
   BlocBuilder<Ma5domeenCubit, Ma5domeenStates>(
     builder: (context, state) {
       return Column(
        children: [

          InkWell(onTap: () {
            Get.toNamed(GetPages.ma5domeenDetailsView , arguments: ma5domeenModel);
          },
            child: Container(
               height: 70,
             ...
             onPressed: (){
               successfullyShowDialog(
                   ...
                   titleText: 'Alert'.tr,
                   contentText:
                       'Are you sure you want to delete this served ?'.tr,
                   buttonText: 'Delete'.tr,
                   onPressed: () {
                     BlocProvider.of<Ma5domeenCubit>(context).deleteMa5doom(stageName: stageName, servedId: servedId);
                     BlocProvider.of<Ma5domeenCubit>(context).gettingMa5domeenData(stageName);
                     });
             },
             child: Text(
               'Delete'.tr,
